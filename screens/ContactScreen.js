...
function ContactScreen({numaf,navigation}) {
    ...
    >
     ...
     >
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        ...
        <TextInput placeholder="Type de problème" 
        ...
        <TextInput placeholder="Type de Contrat" 
        ...
        <Text style={styles.submitText}>Envoyer
        </Text>
    </TouchableHighlight>
